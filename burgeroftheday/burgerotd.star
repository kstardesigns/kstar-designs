                    ...
                    child = 
                        render.Column(
                            children = [
                                ...
                                render.Padding(
                                    render.WrappedText(
                                        content = TODAYS_BURGER_PAR.lower(),
                                        width = 60,
                                        # color = "#fff",  
                                        # alignment = "center" #will need to wait for pixlet update from whyamihere
                                    ), pad = (4, 0, 4, 2)
