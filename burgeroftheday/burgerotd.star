...
Summary: Display the Burger of the Day
Description: Display the set Burger of the Day, show a random burger every time, or enter your own custom burger. Burgers courtesy of Bob's Burgers.
...
#possible bugs:
    #manually changing timezone doesn't change burger even though it should ie. to copenhagen