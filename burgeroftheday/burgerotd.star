...
def main(config):
    TIME_ZONE = config.get("$tz", "America/Phoenix")  # Utilize special timezone variable
    ...
    # # # # LEFT OFF:
    # # # # remove FEB29 burger and parenthetical if not a leap year
...
#left off:
    #options:
        ...
        #time zone - get location if not set like other apps
#to do:
